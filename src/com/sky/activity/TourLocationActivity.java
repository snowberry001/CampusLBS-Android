...
public class TourLocationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tour_location_view);
		...
		myLocationOverlay.setMarker(getResources().getDrawable(R.drawable.tour_location));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item_id) {
			...
			case R.id.locateOK:
				...
				intent.setClass(TourLocationActivity.this, TourCreateActivity.class);
