...
public class PhotoShareViewActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.photo_share_fullscreen);

		sharePhotoIv = (ImageView) findViewById(R.id.sharePhoto);
	
		Bundle bundle = getIntent().getExtras();
		imageUrl = bundle.getString("imageUrl");
		ImageLoader.getInstance().displayImage(imageUrl, sharePhotoIv);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.share_photo_view_menu, menu);
		return true;
	}
	...
	private void deleteSharePhoto(){
		...
		intent.setClass(PhotoShareViewActivity.this, PhotoShareActivity.class);
